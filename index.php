...
<body class="leading-normal tracking-normal text-white gradient" dir="rtl">
  ...
  <header>
    <nav id="header" class="fixed container z-30 mx-auto px-8 top-0 text-white" style="min-width:100%">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-gray-600 lg:bg-transparent  p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 text-white hover:text-gray-400 hover:underline px-4  font-bold no-underline toggleColour" href="index.php" data-i18n="t1">الرئيسية</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-white hover:text-gray-400  no-underline hover:underline py-2 px-4 toggleColour" href="#salat" data-i18n="t2">عدد الصلوات</a>
            </li>
            <li class="mr-3">
            ...
            ?>
              <li class="mr-3">
                <a class="inline-block text-white hover:text-gray-400 no-underline hover:underline py-2 px-4 toggleColour" href="./public/signUp.php" data-i18n="t3">إنشاء حساب</a>
              </li>
          </ul>
          <button id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            <a class="text-gray-800 hover:text-gray-600 no-underline hover:underline py-2 px-4" href="./public/signIn.php" data-i18n="t4">تسجيل الدخول</a>
          </button>
        <?php elseif (isUserLoggedIn()) : ?>
          <li class="mr-3">
            <a class="inline-block text-white hover:text-gray-300 text-black no-underline hover:underline py-2 px-4" href="./auth/logout.php" data-i18n="t5"> تسجيل الخروج </a>
          </li>
          <li class="mr-3">
        ...
        <?php elseif (isUserAdmin()) : ?>
          <li class="mr-3">
            <a class="inline-block text-white hover:text-gray-300 text-black no-underline hover:underline py-2 px-4" href="./auth/logout.php" data-i18n="t7"> تسجيل الخروج </a>
          </li>
          <button id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            <a class="text-gray-800 hover:text-gray-600 text-black no-underline hover:underline py-2 px-4" href="./adminDashboard.php" data-i18n="t8">لوحة التحكم</a>
          </button>
        <?php endif; ?>
        </div>
      </div>
  ...
  <div class="pt-24">
    <div class="container px-7 mx-auto ">
      ...
      <h3 id="textAllPrayers" class="my-4 text-black bg-clip-text text-transparent text-center bg-gradient-to-r from-emerald-900 to-emerald-300 text-4xl leading-tight" style="color:#fff; margin: 0 auto; font-size:30px; display: block;" data-i18n="t9">
    ...
    <div class="container px-7 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-3/5 justify-center items-center text-right">
        ...
        <form class="flex flex-col w-full md:w-3/5 justify-center items-center text-right" id="MyParyersNumber">
          ...
          elseif (!isSession()) :
          ?>
            <span class="mt-4 text-center  " data-i18n="t13"> يرجى تسجيل الدخول او إنشاء حساب جديد كي تتمكن من إدخال صلواتك <br>
              <span style="color:rgb(0,255,0)" data-i18n="t14"> علماً ان التسجيل لمرة واحدة </span>
            </span>
            <div class="text-gray-800 mt-4">
              <a href="./public/signIn.php" class="mx-auto lg:mx-0 w-1/3 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-2 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out mt-2" data-i18n="t15">
                تسجيل الدخول
              </a>
