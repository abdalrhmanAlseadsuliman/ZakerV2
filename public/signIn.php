      ...
      <div class="container max-w-5xl mx-auto m-8">
        <form id="MyLogin">
          <div class="border-b border-gray-900/10 p-12 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800" data-i18n="t90">
              تسجيل الدخول
            </h2>
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-3">
                <label for="first-name" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t52">الايميل</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-3">
                <label for="last-name" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t53">كلمة السر</label>
                <div class="mt-2">
                  ...
                  <fieldset>
                    <div class="mt-4 space-y-6">
                      <div class="flex items-center gap-x-3">
                        <legend class="text-lg font-semibold leading-6 text-gray-900" data-i18n="t47">
            ...
            <br>
            <a href="forgetPassword.php" class="text-emerald-600 text-lg hover:underline" data-i18n="t48">هل نسيت كلمة المرور؟</a>
            <div class="mt-6 w-full">
              <button type="submit" onclick="handleLogin(event)" class="rounded-md w-full bg-emerald-600 px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-emerald-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" data-i18n="t49">
                تسجيل الدخول
              </button>
            </div>
          </div>
