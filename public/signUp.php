      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-gray-600 lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 text-white hover:text-gray-300 hover:underline px-4 text-black font-bold no-underline" href="../index.php" data-i18n="t1">الرئيسية</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-white hover:text-gray-300 text-black no-underline  hover:underline py-2 px-4" href="../index.php#salat" data-i18n="t2">عدد الصلوات</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-white hover:text-gray-300 text-black no-underline hover:underline py-2 px-4" href="signUp.php" data-i18n="t3"> إنشاء حساب </a>
            </li>
          </ul>
          <button id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            <a class="text-black hover:text-gray-600 text-black no-underline hover:underline py-2 px-4" href="signIn.php" data-i18n="t4">تسجيل الدخول</a>
          </button>
        </div>
      </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        <form id="MyRegister">
          <div class="border-b border-gray-900/10 p-12 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800" data-i18n="t33">
              التسجيل في الموقع
              <span style="color:rgb(5,150,105); font-size:18px; display: block;margin-top: 10px;" data-i18n="t34"> علماً ان التسجيل لمرة واحدة </span>
            </h2>
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-3">
                <label for="first-name" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t35">الاسم الأول</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-3">
                <label for="last-name" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t36">الكنية</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-3">
                <label for="email" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t37">عنوان البريد</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-3">
                <label for="country" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t38">البلد</label>
                <div class="mt-2">
                  <select id="inputSelect" name="Nationality" autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600  sm:text-sm sm:leading-6" required>
                    <option disabled selected data-i18n="t39">الجنسية</option>
              ...
              <div class="sm:col-span-4">
                <div class="mt-2">
                  <fieldset>
                    <legend class="text-lg font-semibold leading-6 text-gray-900" data-i18n="t99">
                      الجنس
                    </legend>
                    <div class="mt-6 space-y-6">
                      <div class="flex items-center gap-x-3">
                        ...
                        <label for="push-everything" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t42">ذكر</label>
                      </div>
                      <div class="flex items-center gap-x-3">
                        <input id="Gender" name="Gender" value="female" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
                        <label for="push-email" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t43">أنثى</label>
                      </div>
              ...
              <div class="sm:col-span-2 sm:col-start-1">
                <label for="city" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t44">العمر</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-2">
                <label for="region" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t40">كلمة السر</label>
                <div class="mt-2">
              ...
              <div class="sm:col-span-2">
                <label for="postal-code" class="block text-lg font-medium leading-6 text-gray-900" data-i18n="t41">تأكيد كلمة السر</label>
                <div class="mt-2">
            ...
            <div class="mt-6 w-full">
              <button type="submit" onclick="handleRegistration(event)" class="rounded-md w-full bg-emerald-600 px-3 py-2 text-lg font-semibold text-white shadow-sm hover:bg-emerald-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" data-i18n="t88">
                تسجيل
              </button>
            </div>
          </div>
