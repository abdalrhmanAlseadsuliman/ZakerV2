...
function send_verification_email($email,$vCode){
    ...
    $message = " اهلا وسهلا بكم في موقع ذاكر  .<br>انقر على الرابط أدناه للتحقق من عنوان البريد الإلكتروني <a href='https://zaker.click/public/verifyFront.php?email=$email&vCode=$vCode'> تحقق </a>";
...
function send_forgotPassword_email($email,$vCode){
    ...
    $message = " اهلا وسهلا بكم في موقع ذاكر  .<br> انقر على الرابط أدناه لإعادة تعين كلمة المرور <a href='https://zaker.click/public/resetPassword.php?email=$email&vCode=$vCode'> إعادة تعين </a>";
    return sendmail($email, $subject, $message);
}
